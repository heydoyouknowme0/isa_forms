...
ALTER TABLE "form_answers" ALTER COLUMN "id" SET DEFAULT nextval('form_answers_id_seq');
...
ALTER TABLE "non_teaching_staff" ALTER COLUMN "id" SET DEFAULT nextval('non_teaching_staff_id_seq');
